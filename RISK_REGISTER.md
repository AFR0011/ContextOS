...
| R-2026-06-17-01 | Repo lacked a health endpoint and CI workflow scaffold, leaving deployment verification entirely manual. | High | Closed - v0.2.7 adds no-store `/api/health`, `.github/workflows/ci.yml`, targeted health coverage, and local full verification with 35 passing e2e tests. Remote CI evidence remains tracked under open risk R-2026-06-15-05. |
