...
// Product code should import from this module. Legacy-only implementations stay
// outside this surface while the redesign is completed.
export { AreaDetailView } from "@/components/workspace/AreaDetailView";
